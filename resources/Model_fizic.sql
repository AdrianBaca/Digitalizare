...
-- Started on 2023-03-22 20:42:12
...
CREATE TABLE public."CONSULTATII" (
    ...
    "ListaMedicamente" bigint NOT NULL,
    "ListaAnalize" bigint NOT NULL
);
...
--
-- TOC entry 3420 (class 0 OID 16524)
-- Dependencies: 227
...
--
-- TOC entry 3413 (class 0 OID 16498)
-- Dependencies: 220
-- Data for Name: CONSULTATII; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."CONSULTATII" ("IdConsultatie", "Pacient", "Medic", "ListaMedicamente", "ListaAnalize") FROM stdin;
\.


--
-- TOC entry 3422 (class 0 OID 16533)
-- Dependencies: 229
...
--
-- TOC entry 3414 (class 0 OID 16503)
-- Dependencies: 221
...
--
-- TOC entry 3418 (class 0 OID 16517)
-- Dependencies: 225
...
--
-- TOC entry 3416 (class 0 OID 16509)
-- Dependencies: 223
...
--
-- TOC entry 3412 (class 0 OID 16483)
-- Dependencies: 219
...
--
-- TOC entry 3411 (class 0 OID 16463)
-- Dependencies: 218
...
--
-- TOC entry 3424 (class 0 OID 16540)
-- Dependencies: 231
...
SELECT pg_catalog.setval('public."LISTE_ANALIZE_IdLista_seq"', 1, false);
...
--
-- TOC entry 3255 (class 2606 OID 16561)
-- Name: CONSULTATII CONSULTATII_ListaAnalize_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."CONSULTATII"
    ADD CONSTRAINT "CONSULTATII_ListaAnalize_fkey" FOREIGN KEY ("ListaAnalize") REFERENCES public."LISTE_ANALIZE"("IdLista") NOT VALID;


--
-- TOC entry 3256 (class 2606 OID 16556)
-- Name: CONSULTATII CONSULTATII_ListaMedicamente_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."CONSULTATII"
    ADD CONSTRAINT "CONSULTATII_ListaMedicamente_fkey" FOREIGN KEY ("ListaMedicamente") REFERENCES public."LISTE_MEDICAMENTE"("IdMedicament") NOT VALID;
...
--
-- TOC entry 3258 (class 2606 OID 16546)
...
--
-- TOC entry 3259 (class 2606 OID 16566)
...
--
-- TOC entry 3260 (class 2606 OID 16571)
...
--
-- TOC entry 3261 (class 2606 OID 16586)
...
--
-- TOC entry 3262 (class 2606 OID 16591)
...
-- Completed on 2023-03-22 20:42:12
